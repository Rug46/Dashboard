...
//            datasets: [{
//                label: 'Minutes',
//                data: [16, 32, 37, 28, 18, 10, 36, 27, 24, 28],
...
var ctx = document.getElementById("hours_week").getContext('2d');
...
var ctx = document.getElementById("hours_month").getContext('2d');
var chart = new Chart(ctx, {
    // The type of chart we want to create
    type: 'line',
    // The data for our dataset
...
if ($('#verview-shart').length) {
    var myConfig = {
        ...
        "plot": { "aspect": "spline" },
        "series": [{
                "values": [6, 7, 4, 6, 8, 3, 9, 11, 7, 6, 4, 7],
                "line-color": "#F0B41A",
                /* "dotted" | "dashed" */
